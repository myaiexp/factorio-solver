// The far-lane invariant `lane.rs` states but Phase 6 never checked, shared-
// belt lane ownership between adjacent cells, inserter-tier selection by
// reach, containment/no-overlap at a negative origin, both named refusals, a
// partly-filled trailing cell, the topology flip onto the spine, and a
// column's reserved pole rows.
